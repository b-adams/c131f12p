/**
 * @file cs131_program_1_pbadianpessot.c
 * @author Pamela Badian-Pessot
 * @author Prof. Adams
 * @date THE September 7, 2012
 */
...
/**
 * @author Prof Adams
 * @brief Find the square of a number
 * @param thingToSquare the number that will be squared.
 * @sideeffect Prints "The square of the N is M" Where N is thingToSquare and M is N sqaured
 * @return The square of the thingToSquare
 */
...
int nextInteger(int previous)
{
        printf("\tThe integer adfter %d is &d\n",
               previou, (previous+1));
        return (previous+1);
}
