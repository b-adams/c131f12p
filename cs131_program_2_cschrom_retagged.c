...
{
   int theResult;
   if(exponent==0) theResult = 1;
   else if(exponent==1) theResult = 2;
   else if(exponent==2) theResult = 4;
   else theResult = 8;
   return theResult;
}
